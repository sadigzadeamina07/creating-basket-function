...
<i onclick="bagla2()" class="fa-solid fa-xmark text-2xl "></i>
</div>
        ...
        <img class="object-contain bg-center p-4 w-full h-[50vh]" 
            ...
            <div class="p-2 mb-2">
                <h3 class=" uppercase text-gray-500">${tap.category}</h3>
                <p class=" mt-8 font-bold">${tap.title}</p>
                <span class="mt-3 text-gray-500 ">${tap.description}</span>
               <div class="flex justify-between  flex-wrap  mt-6">
               <h2 class="font-bold text-3xl ">$ ${tap.price}</h2>
<button onclick="addbasket(${tap.id})" class="bg-blue-700 flex gap-3 items-center text-white px-4  py-2 rounded"> <i class="fa-regular fa-cart-shopping"></i>Əlavə et</button>
               </div>
</div>
